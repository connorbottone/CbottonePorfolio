...
const Footer= () => {
  return (
   ...
   <div style={style.img}>
    <div style={style.github}><a href='https://github.com/connorbottone?tab=repositories'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
