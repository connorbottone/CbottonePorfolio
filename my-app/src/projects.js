...
const projects = [
    ...
    {
        title: "TETROMANIA",
        descripton: "=ate a random passwordthe letasswordassword length>8 and <128 or enters a value in text fromat the user will be prompted to reenter there desired length.",
        webpagelink: "https://localtetris.herokuapp.com/",
